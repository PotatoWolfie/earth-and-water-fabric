...
public class BoreEntityRenderer extends MobEntityRenderer<BoreEntity, BoreEntityRenderState, BoreEntityModel> {
    ...
    public void render(BoreEntityRenderState boreEntityRenderState, MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int i) {
        ...
        super.render(boreEntityRenderState, matrixStack, vertexConsumerProvider, i);
    }

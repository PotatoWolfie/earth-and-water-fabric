...
public class SpikedShieldEntityModel extends net.minecraft.client.render.entity.model.ShieldEntityModel {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		// Main shield plate - solid body that can have banners applied
		...
		// Spikes - separate part that won't have banners applied, always transparent
		...
		// Handle - empty but required for ShieldEntityModel
	...
	public void render(ItemStack stack, MatrixStack matrices, VertexConsumerProvider vertexConsumers,
		...
		// Get the appropriate sprite based on whether there are patterns
		...
		VertexConsumer vertexConsumer = spriteToUse.getSprite().getTextureSpecificVertexConsumer(

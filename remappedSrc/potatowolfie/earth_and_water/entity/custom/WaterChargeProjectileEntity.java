...
public class WaterChargeProjectileEntity extends PersistentProjectileEntity {
    ...
    private void createDirectHitEffect(Entity hitEntity) {
        ...
        if (!world.isClient() && world instanceof ServerWorld serverWorld) {
            ...
            Vec3d explosionPos = exactHitPosition != null ? exactHitPosition : this.getPos();
    ...
    protected void onEntityHit(EntityHitResult entityHitResult) {
        ...
        if (entity instanceof LivingEntity livingEntity) {
            if (getWorld() instanceof ServerWorld serverWorld) {
                livingEntity.damage(serverWorld, getWorld().getDamageSources().explosion(this, this.getOwner()), DIRECT_DAMAGE);
            }
    ...
    public void writeCustomData(WriteView nbt) {
        ...
        if (attachedFace != null) {
            nbt.putInt("AttachedFace", Integer.parseInt(attachedFace.getId()));
        }
    ...
    public void readCustomData(ReadView nbt) {
        ...
        if (faceId != -1) {
            attachedFace = Direction.byId(String.valueOf(faceId));
        }
